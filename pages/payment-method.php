...
<!-- Mirrored from codescandy.com/geeks/pages/payment-method.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:24 GMT -->
<head>
	<!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
	<title>Payment Method | Geeks - Academy Admin Template</title>
</head>
			...
			<div class="row mt-0 mt-md-4">
				...
				<div class="col-lg-9 col-md-8 col-12">
					...
					<div class="card mb-4">
						...
						<!-- Card body -->
						<div class="card-body">
							<h2 class="font-weight-bold mb-0">$39/Monthly</h2>
							<p class="mb-0">
					...
					<div class="card mb-4">
						...
						<div class="card-body">
							...
							<ul class="list-group list-group-flush">
								...
								<li class="list-group-item px-0 pb-3 pt-0">
									<div class="d-flex justify-content-between">
										<div class="d-flex">
											<img src="../assets/images/creditcard/visa.svg" alt="" class="mr-3" />
											<div>
												<h5 class="mb-0">Visa ending in 1234</h5>
												<p class="mb-0 font-size-xs">Expires in 10/2021</p>
											</div>
										</div>
										<div>
											<span class="badge badge-success mr-4">Primary</span>
											<span class="dropdown">
												<a class="text-muted text-decoration-none" href="#!" role="button" id="paymentDropdown"
													data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
													<i class="fe fe-more-vertical"></i>
												</a>
												<span class="dropdown-menu dropdown-menu-right" aria-labelledby="paymentDropdown">
								...
								<li class="list-group-item px-0 py-3">
									<div class="d-flex justify-content-between">
										<div class="d-flex">
											<img src="../assets/images/creditcard/mastercard.svg" alt="" class="mr-3" />
											<div>
												<h5 class="mb-0">Mastercard ending in 1234</h5>
												<p class="mb-0 font-size-xs">Expires in 03/2022</p>
											</div>
										</div>
										<span class="dropdown">
											...
											<span class="dropdown-menu dropdown-menu-right" aria-labelledby="paymentDropdown1">
												<span class="dropdown-header">Setting </span>
												<a class="dropdown-item" href="#!"><i class="fe fe-edit dropdown-item-icon"></i>Edit</a>
												<a class="dropdown-item" href="#!"><i class="fe fe-trash dropdown-item-icon"></i>Remove</a>
												<a class="dropdown-item" href="#!"><i class="fe fe-credit-card dropdown-item-icon"></i>Make it
								...
								<li class="list-group-item px-0 py-3">
									<div class="d-flex justify-content-between">
										<div class="d-flex">
											<img src="../assets/images/creditcard/discover.svg" alt="" class="mr-3" />
											<div>
												<h5 class="mb-0">Discover ending in 1234</h5>
												<p class="mb-0 font-size-xs">Expires in 07/2021</p>
											</div>
										</div>
										<span class="dropdown">
											...
											<span class="dropdown-menu dropdown-menu-right" aria-labelledby="paymentDropdown2">
												<span class="dropdown-header">Setting </span>
												<a class="dropdown-item" href="#!"><i class="fe fe-edit dropdown-item-icon"></i>Edit</a>
												<a class="dropdown-item" href="#!"><i class="fe fe-trash dropdown-item-icon"></i>Remove</a>
												<a class="dropdown-item" href="#!"><i class="fe fe-credit-card dropdown-item-icon"></i>Make it
								...
								<li class="list-group-item px-0 py-3">
									<div class="d-flex justify-content-between">
										<div class="d-flex">
											<img src="../assets/images/creditcard/americanexpress.svg" alt="" class="mr-3" />
											<div>
												<h5 class="mb-0">American Express ending in 1234</h5>
												<p class="mb-0 font-size-xs">Expires in 12/2021</p>
											</div>
										</div>
										<span class="dropdown">
											...
											<span class="dropdown-menu dropdown-menu-right" aria-labelledby="paymentDropdown3">
												<span class="dropdown-header">Setting </span>
												<a class="dropdown-item" href="#!"><i class="fe fe-edit dropdown-item-icon"></i>Edit</a>
												<a class="dropdown-item" href="#!"><i class="fe fe-trash dropdown-item-icon"></i>Remove</a>
												<a class="dropdown-item" href="#!"><i class="fe fe-credit-card dropdown-item-icon"></i>Make it
								...
								<li class="list-group-item px-0 py-3 border-bottom">
									<div class="d-flex justify-content-between">
										<div class="d-flex">
											<img src="../assets/images/creditcard/paypal.svg" alt="" class="mr-3" />
											<div>
										...
										<span class="dropdown">
											...
											<span class="dropdown-menu dropdown-menu-right" aria-labelledby="paymentDropdown4">
												<span class="dropdown-header">Setting </span>
												<a class="dropdown-item" href="#!"><i class="fe fe-edit dropdown-item-icon"></i>Edit</a>
												<a class="dropdown-item" href="#!"><i class="fe fe-trash dropdown-item-icon"></i>Remove</a>
												<a class="dropdown-item" href="#!"><i class="fe fe-credit-card dropdown-item-icon"></i>Make it
							...
							<!-- button-->
							<a href="#!" class="btn btn-outline-primary mt-4" data-toggle="modal" data-target="#paymentModal">Add
								Payment Method</a>
						</div>
					</div>
				</div>
...
<!-- Mirrored from codescandy.com/geeks/pages/payment-method.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:25 GMT -->
</html>