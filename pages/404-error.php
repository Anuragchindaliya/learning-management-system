...
<!-- Mirrored from codescandy.com/geeks/pages/404-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:19 GMT -->
<head>
 <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
 <title>404 Error | Geeks - Academy Admin Template</title>
</head>
...
<body class="bg-white">
 ...
 <div class="container d-flex flex-column">
  ...
  <div class="row align-items-center justify-content-center no-gutters py-lg-22 py-10">
   <!-- Docs -->
   <div class="offset-xl-1 col-xl-4 col-lg-6 col-md-12 col-12 text-center text-lg-left">
