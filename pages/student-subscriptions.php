...
<!-- Mirrored from codescandy.com/geeks/pages/student-subscriptions.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:13:01 GMT -->
<head>
	<!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
	<title>Subscriptions | Geeks - Academy Admin Template</title>
</head>
							...
							<div class="border-bottom pt-0 pb-5">
								...
								<div class="row">
									<div class="col-lg-3 col-md-3 col-6 mb-2 mb-lg-0">
										<span class="font-size-xs">Started On</span>
										<h6 class="mb-0">Oct 1, 2020</h6>
									</div>
									<div class="col-lg-3 col-md-3 col-6 mb-2 mb-lg-0">
										<span class="font-size-xs">Price</span>
										<h6 class="mb-0">Monthly</h6>
									</div>
									<div class="col-lg-3 col-md-3 col-6 mb-2 mb-lg-0">
										<span class="font-size-xs">Access</span>
										<h6 class="mb-0">Access All Courses</h6>
									</div>
									<div class="col-lg-3 col-md-3 col-6 mb-2 mb-lg-0">
										<span class="font-size-xs">Billing Date</span>
