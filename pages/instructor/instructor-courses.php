...
<!-- Mirrored from codescandy.com/geeks/pages/instructor-courses.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:22 GMT -->
<head>
	<!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
	<title>Instructor Courses | Geeks - Academy Admin Template</title>
</head>
							...
							<table class="table mb-0 text-nowrap">
								...
								<tbody>
									<tr>
										<td class="border-top-0">
											<div class="d-lg-flex">
												<div>
													<a href="#!">
														<img src="../assets/images/course/course-wordpress.jpg" alt="" class="rounded img-4by3-lg" /></a>
												</div>
												<div class="ml-lg-3 mt-2 mt-lg-0">
													...
													<ul class="list-inline font-size-xs mb-0">
														<li class="list-inline-item">
															<i class="far fa-clock mr-1"></i>1h 30m
														</li>
														<li class="list-inline-item">
									...
									<tr>
										<td>
											<div class="d-lg-flex">
												...
												<div class="ml-lg-3 mt-2 mt-lg-0">
													...
													<ul class="list-inline font-size-xs mb-0">
														<li class="list-inline-item">
															<i class="far fa-clock mr-1"></i>3h 40m
														</li>
														<li class="list-inline-item">
															<svg class="mr-1 mt-n1" width="16" height="16" viewBox="0 0 16 16" fill="none"
																xmlns="http://www.w3.org/2000/svg">
										...
										<td><span class="badge badge-info">Darft</span></td>
										<td class="text-muted">
											<span class="dropdown">
									...
									<tr>
										<td>
											<div class="d-lg-flex">
												<div>
													<a href="#!">
														<img src="../assets/images/course/course-laravel.jpg" alt="" class="rounded img-4by3-lg" /></a>
												</div>
												<div class="ml-lg-3 mt-2 mt-lg-0">
													<h4 class="mb-1 h5">
														<a href="#!" class="text-inherit">
									...
									<tr>
										<td>
											<div class="d-lg-flex">
												<div>
													<a href="#!">
														<img src="../assets/images/course/course-gatsby.jpg" alt="" class="rounded img-4by3-lg" /></a>
												</div>
												<div class="ml-lg-3 mt-2 mt-lg-0">
													<h4 class="mb-1 h5">
														<a href="#!" class="text-inherit">
													...
													<ul class="list-inline font-size-xs mb-0">
														<li class="list-inline-item">
															<i class="far fa-clock mr-1"></i>4h 10m
														</li>
														<li class="list-inline-item">
															<svg class="mr-1 mt-n1" width="16" height="16" viewBox="0 0 16 16" fill="none"
																xmlns="http://www.w3.org/2000/svg">
										...
										<td>
											<div class="d-lg-flex">
												...
												<div class="ml-lg-3 mt-2 mt-lg-0">
													...
													<ul class="list-inline font-size-xs mb-0">
														<li class="list-inline-item">
															<i class="far fa-clock mr-1"></i>2h 59m
														</li>
														<li class="list-inline-item">
															<svg class="mr-1 mt-n1" width="16" height="16" viewBox="0 0 16 16" fill="none"
																xmlns="http://www.w3.org/2000/svg">
									...
									<tr>
										...
										<td class="text-muted">
											<span class="dropdown">
												<a class="text-muted text-decoration-none" href="#!" id="courseDropdown5" data-toggle="dropdown"
