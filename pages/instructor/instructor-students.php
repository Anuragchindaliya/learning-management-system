...
<!-- Mirrored from codescandy.com/geeks/pages/instructor-students.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:22 GMT -->
<head>
	<!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
	<title>Instructor Students | Geeks - Academy Admin Template</title>
</head>
									...
									<div class="card mb-4">
										...
										<div class="card-body">
											<div class="text-center">
												...
												<p class="mb-0 font-size-xs">
													<i class="fe fe-map-pin mr-1"></i>United States
												</p>
									...
									<div class="card mb-4">
										...
										<div class="card-body">
											<div class="text-center">
												...
												<p class="mb-0 font-size-xs">
													<i class="fe fe-map-pin mr-1"></i>India
												</p>
												<a href="#!" class="btn btn-sm btn-outline-white mt-3">Message</a>
											</div>
											<div class="d-flex justify-content-between border-bottom py-2 mt-4 font-size-xs">
									...
									<div class="card mb-4">
										...
										<div class="card-body">
											<div class="text-center">
												...
												<p class="mb-0 font-size-xs">
													<i class="fe fe-map-pin mr-1"></i>UK
												</p>
												<a href="#!" class="btn btn-sm btn-outline-white mt-3">Message</a>
											</div>
											<div class="d-flex justify-content-between border-bottom py-2 mt-4 font-size-xs">
									...
									<div class="card mb-4">
										...
										<div class="card-body">
											<div class="text-center">
												...
												<p class="mb-0 font-size-xs">
													<i class="fe fe-map-pin mr-1"></i>Brazil
												</p>
												<a href="#!" class="btn btn-sm btn-outline-white mt-3">Message</a>
											</div>
											<div class="d-flex justify-content-between border-bottom py-2 mt-4 font-size-xs">
									...
									<div class="card mb-4">
										...
										<div class="card-body">
											<div class="text-center">
												...
												<p class="mb-0 font-size-xs">
													<i class="fe fe-map-pin mr-1"></i>Chile
												</p>
												<a href="#!" class="btn btn-sm btn-outline-white mt-3">Message</a>
											</div>
											<div class="d-flex justify-content-between border-bottom py-2 mt-4 font-size-xs">
									...
									<div class="card mb-4">
										...
										<div class="card-body">
											<div class="text-center">
												...
												<p class="mb-0 font-size-xs">
													<i class="fe fe-map-pin mr-1"></i>Estonia
												</p>
												<a href="#!" class="btn btn-sm btn-outline-white mt-3">Message</a>
											</div>
											<div class="d-flex justify-content-between border-bottom py-2 mt-4 font-size-xs">
									...
									<div class="card mb-4">
										...
										<div class="card-body">
											<div class="text-center">
												...
												<p class="mb-0 font-size-xs">
													<i class="fe fe-map-pin mr-1"></i>Greece
												</p>
												<a href="#!" class="btn btn-sm btn-outline-white mt-3">Message</a>
											</div>
											<div class="d-flex justify-content-between border-bottom py-2 mt-4 font-size-xs">
									...
									<div class="card mb-4">
										...
										<div class="card-body">
											<div class="text-center">
												...
												<p class="mb-0 font-size-xs">
													<i class="fe fe-map-pin mr-1"></i>Egypt
												</p>
												<a href="#!" class="btn btn-sm btn-outline-white mt-3">Message</a>
											</div>
											<div class="d-flex justify-content-between border-bottom py-2 mt-4 font-size-xs">
									...
									<div class="card mb-4">
										...
										<div class="card-body">
											<div class="text-center">
												...
												<p class="mb-0 font-size-xs">
													<i class="fe fe-map-pin mr-1"></i>Denmark
												</p>
												<a href="#!" class="btn btn-sm btn-outline-white mt-3">Message</a>
											</div>
											<div class="d-flex justify-content-between border-bottom py-2 mt-4 font-size-xs">
									...
									<table class="table">
										...
										<tbody>
											<tr>
												...
												<td class="pr-0 align-middle border-top-0">
											...
											<tr>
												<td class="align-middle">
													<div class="d-flex align-items-center">
														<img src="../assets/images/avatar/avatar-6.jpg" alt="" class="rounded-circle avatar-md mr-2" />
											...
											<tr>
												<td class="align-middle">
													<div class="d-flex align-items-center">
														<img src="../assets/images/avatar/avatar-7.jpg" alt="" class="rounded-circle avatar-md mr-2" />
												...
												<td class="align-middle">
													<span class="font-size-xs"><i class="fe fe-map-pin mr-1"></i>Egypt</span>
												</td>
												<td class="pr-0 align-middle">
													<a href="#!" class="btn btn-outline-white btn-sm">Message</a>
												</td>
											...
											<tr class="border-bottom">
												<td class="align-middle">
													<div class="d-flex align-items-center">
														<img src="../assets/images/avatar/avatar-9.jpg" alt="" class="rounded-circle avatar-md mr-2" />
												...
												<td class="align-middle">4</td>
												<td class="align-middle">
													<span class="font-size-xs"><i class="fe fe-map-pin mr-1"></i>Denmark</span>
												</td>
												<td class="pr-0 align-middle">
													<a href="#!" class="btn btn-outline-white btn-sm">Message</a>
												</td>
