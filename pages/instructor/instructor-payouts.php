...
<!-- Mirrored from codescandy.com/geeks/pages/instructor-payouts.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:22 GMT -->
<head>
	<!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
	<title>Instructor Payouts | Geeks - Academy Admin Template</title>
</head>
					...
					<div
						...
						<div class="d-flex align-items-center">
							<div class="mr-2 position-relative d-flex justify-content-end align-items-end mt-n5">
								<img src="../assets/images/avatar/avatar-1.jpg" class="avatar-xl rounded-circle border-width-4 border-white position-relative"
									alt="" />
				...
				<div class="col-lg-9 col-md-8 col-12">
					...
					<div class="card mb-4">
						...
						<div class="card-header border-bottom-0">
							...
							<div class="row align-items-center">
								<div class="col-lg-3 col-md-6 pr-md-0 mb-2 mb-lg-0">
										<!-- Custom select -->
								...
								<div class="col-lg-3 col-md-6 pr-md-0 mb-2 mb-2 mb-lg-0">
										<!-- Custom select -->
									<select class="selectpicker" data-width="100%">
								...
								<div class="col-lg-4 col-md-6 mb-2 mb-2 mb-lg-0">
										<!-- Custom select -->
									<select class="selectpicker" data-width="100%">
								...
								<div class="col-lg-2 col-md-6 text-lg-right">
										<!-- Button -->
									<a href="#!" class="btn btn-outline-white" download="">
							...
							<table class="table mb-0 text-nowrap">
								...
								<tbody>
									<tr>
										...
										<td class="align-middle border-top-0">#1060</td>
										<td class="align-middle border-top-0">PayPal</td>
										<td class="align-middle border-top-0">
											<span class="badge badge-warning">Pending</span>
										</td>
										<td class="align-middle border-top-0">$1200</td>
										<td class="align-middle border-top-0">Sept 15, 2020</td>
										<td class="align-middle border-top-0">
											<span class="dropdown">
									...
									<tr>
										<td>
											<div class="custom-control custom-checkbox">
												<input type="checkbox" class="custom-control-input" id="withdrawThree" />
												<label class="custom-control-label" for="withdrawThree"></label>
											</div>
										</td>
										<td class="align-middle">#1038</td>
										<td class="align-middle">PayPal</td>
										<td class="align-middle">
											<span class="badge badge-success">Paid</span>
										</td>
										<td class="align-middle">$2000</td>
										<td class="align-middle">Aug 15, 2020</td>
										<td class="align-middle">
											<span class="dropdown">
												<a class="text-muted text-decoration-none" href="#!" role="button" id="paymentDropdown1"
													data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
													<i class="fe fe-more-vertical"></i>
												</a>
									...
									<tr>
										<td>
											<div class="custom-control custom-checkbox">
												<input type="checkbox" class="custom-control-input" id="withdrawFour" />
												<label class="custom-control-label" for="withdrawFour"></label>
											</div>
										</td>
										<td class="align-middle">#1016</td>
										<td class="align-middle">PayPal</td>
										<td class="align-middle">
											<span class="badge badge-success">Paid</span>
										</td>
										<td class="align-middle">$3590</td>
										<td class="align-middle">July 15, 2020</td>
										<td class="align-middle">
											<span class="dropdown">
												<a class="text-muted text-decoration-none" href="#!" role="button" id="paymentDropdown2"
													data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
													<i class="fe fe-more-vertical"></i>
												</a>
									...
									<tr>
										<td>
											<div class="custom-control custom-checkbox">
												<input type="checkbox" class="custom-control-input" id="withdrawFive" />
												<label class="custom-control-label" for="withdrawFive"></label>
											</div>
										</td>
										<td class="align-middle">#1008</td>
										<td class="align-middle">PayPal</td>
										<td class="align-middle">
											<span class="badge badge-success">Paid</span>
										</td>
										...
										<td class="align-middle">
											<span class="dropdown">
												<a class="text-muted text-decoration-none" href="#!" role="button" id="paymentDropdown3"
													data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
													<i class="fe fe-more-vertical"></i>
												</a>
									...
									<tr>
										<td>
											<div class="custom-control custom-checkbox">
												<input type="checkbox" class="custom-control-input" id="withdrawSix" />
												<label class="custom-control-label" for="withdrawSix"></label>
											</div>
										</td>
										<td class="align-middle">#1002</td>
										<td class="align-middle">PayPal</td>
										<td class="align-middle">
											<span class="badge badge-success">Paid</span>
										</td>
										<td class="align-middle">$4500</td>
										<td class="align-middle">May 15, 2020</td>
										<td class="align-middle">
											<span class="dropdown">
									...
									<tr>
										<td>
											<div class="custom-control custom-checkbox">
												<input type="checkbox" class="custom-control-input" id="withdrawSeven" />
												<label class="custom-control-label" for="withdrawSeven"></label>
											</div>
										</td>
										<td class="align-middle">#982</td>
										<td class="align-middle">PayPal</td>
										<td class="align-middle">
											<span class="badge badge-success">Paid</span>
										</td>
										<td class="align-middle">$1232</td>
										<td class="align-middle">April 15, 2020</td>
										<td class="align-middle">
											<span class="dropdown">
												<a class="text-muted text-decoration-none" href="#!" role="button" id="paymentDropdown5"
													data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
													<i class="fe fe-more-vertical"></i>
												</a>
									...
									<tr>
										<td>
											<div class="custom-control custom-checkbox">
												<input type="checkbox" class="custom-control-input" id="withdrawEight" />
												<label class="custom-control-label" for="withdrawEight"></label>
											</div>
										</td>
										...
										<td class="align-middle">$4235</td>
										<td class="align-middle">March 15, 2020</td>
										<td class="align-middle">
											<span class="dropdown">
												<a class="text-muted text-decoration-none" href="#!" role="button" id="paymentDropdown6"
													data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
													<i class="fe fe-more-vertical"></i>
												</a>
									...
									<tr>
										<td>
											<div class="custom-control custom-checkbox">
												<input type="checkbox" class="custom-control-input" id="withdrawNine" />
												<label class="custom-control-label" for="withdrawNine"></label>
											</div>
										</td>
										<td class="align-middle">#965</td>
										<td class="align-middle">PayPal</td>
										<td class="align-middle">
											<span class="badge badge-success">Paid</span>
										</td>
										<td class="align-middle">$1231</td>
										<td class="align-middle">Feb 15, 2020</td>
										<td class="align-middle">
											<span class="dropdown">
												<a class="text-muted text-decoration-none" href="#!" role="button" id="paymentDropdown7"
													data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
													<i class="fe fe-more-vertical"></i>
												</a>
									...
									<tr>
										<td>
											<div class="custom-control custom-checkbox">
												<input type="checkbox" class="custom-control-input" id="withdrawTen" />
												<label class="custom-control-label" for="withdrawTen"></label>
											</div>
										</td>
										<td class="align-middle">#953</td>
										<td class="align-middle">PayPal</td>
										<td class="align-middle">
											<span class="badge badge-success">Paid</span>
										</td>
										<td class="align-middle">$5435</td>
										<td class="align-middle">Jan 15, 2020</td>
										<td class="align-middle">
											<span class="dropdown">
												<a class="text-muted text-decoration-none" href="#!" role="button" id="paymentDropdown8"
													data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
													<i class="fe fe-more-vertical"></i>
												</a>
...
<!-- Mirrored from codescandy.com/geeks/pages/instructor-payouts.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:24 GMT -->
</html>