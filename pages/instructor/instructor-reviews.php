...
<!-- Mirrored from codescandy.com/geeks/pages/instructor-reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:22 GMT -->
<head>
	<!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
	<title>Reviews | Geeks - Academy Admin Template</title>
</head>
										...
										<div class="ml-3 mt-2 media-body">
											<div class="d-flex align-items-center justify-content-between">
												<div>
													...
													<span class="text-muted font-size-xs">2 hour ago</span>
												</div>
												<div>
													<a href="#!" data-toggle="tooltip" data-placement="top" title="Report Abuse"><i
										...
										<div class="ml-3 mt-2 media-body">
											...
											<div class="mt-2">
												<span class="mr-1">
													...
													<i class="mdi mdi-star mr-n1 mb-2 text-warning font-size-xs"></i>
													<i class="mdi mdi-star mr-n1 mb-2 text-warning font-size-xs"></i>
													<i class="mdi mdi-star mb-2-half-alt text-warning font-size-xs"></i>
												</span>
												<span class="mr-1">for</span>
										...
										<div class="ml-3 mt-2 media-body">
											<div class="d-flex align-items-center justify-content-between">
												<div>
													...
													<span class="text-muted font-size-xs">1 hour ago</span>
												</div>
												<div>
													<a href="#!" data-toggle="tooltip" data-placement="top" title="Report Abuse"><i
															class="fe fe-flag"></i></a>
											...
											<div class="mt-2">
												<span class="mr-1">
													...
													<i class="mdi mdi-star mr-n1 mb-2 text-warning font-size-xs"></i>
													<i class="mdi mdi-star mr-n1 mb-2 text-warning font-size-xs"></i>
													<i class="mdi mdi-star mb-2 text-light font-size-xs"></i>
												</span>
												<span class="mr-1">for</span>
										...
										<div class="ml-3 mt-2 media-body">
											<div class="d-flex align-items-center justify-content-between">
												<div>
													...
													<span class="text-muted font-size-xs">3 hour ago</span>
												</div>
												<div>
													<a href="#!" data-toggle="tooltip" data-placement="top" title="Report Abuse"><i
															class="fe fe-flag"></i></a>
