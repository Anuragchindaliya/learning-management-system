...
<!-- Mirrored from codescandy.com/geeks/pages/course-path.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:13:44 GMT -->
<head>
  <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
  <title>Course Path | Geeks - Academy Admin Template</title>
</head>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="row justify-content-between align-items-center">
            ...
            <div class="col-xl-2 col-md-3 col-6 pr-0">
              <!-- Custom select -->
          ...
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              ...
              <div class="ml-3">
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">12</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">34 </span>
                    Hours</span>
                </p>
              </div>
            </div>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-javascript.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-angular.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    AngularJS
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">13</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">50 </span>
                    Hours</span>
                </p>
              </div>
            </div>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-css.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    Advanced CSS course
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">6</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">11 </span>
                    Hours</span>
                </p>
              </div>
            </div>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-gatsby.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    GatsbyJS
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-react.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    React
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">20</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">12 </span>
                    Hours</span>
                </p>
              </div>
            </div>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-graphql.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    GraphQl
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">16</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">24 </span>
                    Hours</span>
                </p>
              </div>
            </div>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-vue-js.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    Vue Js
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">12</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">17</span>
                    Hours</span>
                </p>
              </div>
            </div>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-nodejs.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    Node js
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">8</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">17</span>
                    Hours</span>
                </p>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-python.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    Python
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">32</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">12</span>
                    Hours</span>
                </p>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-grunt.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    Grunt
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">8</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">23</span>
                    Hours</span>
                </p>
              </div>
            </div>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-sass.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    Sass
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">6</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">43</span>
                    Hours</span>
                </p>
              </div>
            </div>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-html.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    HTML5
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">24</span>Courses</span>
                  <span><span class="text-dark font-weight-medium">32</span>
                    Hours</span>
                </p>
              </div>
            </div>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-sketch.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    Sketch
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-invision.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    Invision
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-invision-studio.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    Invision Studio
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">10</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">16</span>
                    Hours</span>
                </p>
              </div>
            </div>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-figma-log.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    Figma
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-adobe-xd.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    Adobe XD
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">14</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">26</span>
                    Hours</span>
                </p>
              </div>
            </div>
        ...
        <div class="card mb-4 card-hover">
          <div class="d-flex justify-content-between align-items-center p-4">
            <div class="d-flex">
              <a href="course-path-single.html">
                 <!-- Img -->
                <img src="../assets/images/path/path-illustrator.jpg" alt="" class="avatar-md" /></a>
              <div class="ml-3">
                <h4 class="mb-1">
                  <a href="course-path-single.html" class="text-inherit">
                    Adobe Illustrator
                ...
                <p class="mb-0 font-size-xs">
                  <span class="mr-2"><span class="text-dark font-weight-medium">5</span>
                    Courses</span>
                  <span><span class="text-dark font-weight-medium">16</span>
                    Hours</span>
                </p>
...
<!-- Mirrored from codescandy.com/geeks/pages/course-path.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:13:52 GMT -->
</html>