                ...
                <div class="card">
                    ...
                    <div class="card-body border-top">
                        ...
                        <div class="custom-control custom-checkbox mb-1">
                            ...
                            <label class="custom-control-label" for="allTwoCheck">All Level</label>
                        </div>
                        <!-- Checkbox -->
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" class="custom-control-input" id="beginnerTwoCheck" checked>
                            <label class="custom-control-label" for="beginnerTwoCheck">Beginner</label>
                        </div>
                        <!-- Checkbox -->
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" class="custom-control-input" id="intermediateCheck">
                            <label class="custom-control-label" for="intermediateCheck">Intermediate</label>
                        </div>
                        <!-- Checkbox -->
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" class="custom-control-input" id="AdvancedTwoCheck">
                            <label class="custom-control-label" for="AdvancedTwoCheck">Advance</label>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card  mb-4 card-hover">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="mb-3 list-inline">
                                            ...
                                            <li class="list-inline-item"><svg class="mr-1 mt-n1" width="16" height="16"
                                ...
                                <div class="col-lg-9 col-md-12 col-12">
                                    ...
                                    <div class="card-body">
                                        <h3 class="mb-2 text-truncate-line-2 "><a href="#!"
                                                class="text-inherit">Bootstrap 5 Beginner
                                                Tutorial</a></h3>
                                        <!-- List inline -->
                                        <ul class="mb-5 list-inline">
                                            <li class="list-inline-item"><i class="far fa-clock mr-1"></i>2h 46m
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="mb-5 list-inline">
                                            ...
                                            <li class="list-inline-item"> <span>
                                                ...
                                                <span class="text-warning">4.5</span>
                                                <span class="font-size-xs text-muted">(3,200)</span>
                                            </li>
                                        </ul>
                                        <!-- Row -->
                                        <div class="row align-items-center no-gutters">
                        ...
                        <div class="card mb-4 card-hover">
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-9 col-md-12 col-12">
                                    ...
                                    <div class="card-body">
                                        <h3 class="mb-2 text-truncate-line-2 "><a href="#!"
                                                class="text-inherit">Applying JavaScript and
                                                using the console.</a>
                                        </h3>
                                        <!-- List inline -->
                                        <ul class="mb-5 list-inline">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="mb-5 list-inline">
                                            ...
                                            <li class="list-inline-item"> <span>
                                                ...
                                                <span class="text-warning">4.5</span>
                                                <span class="font-size-xs text-muted">(2,700)</span>
                                            </li>
                                        </ul>
                                        <!-- row -->
                                        <div class="row align-items-center no-gutters">
