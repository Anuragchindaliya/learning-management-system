...
<!-- Mirrored from codescandy.com/geeks/pages/course-single-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:13:39 GMT -->
<head>
  <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
  <title>Course Single | Geeks - Academy Admin Template</title>
</head>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-12 mb-5">
          <div class="rounded-lg embed-responsive embed-responsive-16by9" style="height: 600px;">
          ...
          <div class="card mb-5">
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                <h1 class="font-weight-semi-bold mb-2">
                  Getting Started with JavaScript
                </h1>
                <a href="#!" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add to Bookmarks">
              ...
              <div class="d-flex mb-5">
                <span>
                  ...
                  <span class="font-weight-medium">(140)</span>
                </span>
              ...
              <div class="d-flex justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ml-2 lh-1">
                    ...
                    <p class="font-size-xs mb-0">@kathrynjones</p>
                  </div>
                </div>
                <div>
            ...
            <ul class="nav nav-lt-tab" id="tab" role="tablist">
              ...
              <!-- Nav item -->
              <li class="nav-item">
                <a class="nav-link" id="review-tab" data-toggle="pill" href="#review" role="tab" aria-controls="review"
                  aria-selected="false">Reviews</a>
              </li>
              <!-- Nav item -->
              <li class="nav-item">
                <a class="nav-link" id="transcript-tab" data-toggle="pill" href="#transcript" role="tab"
                  aria-controls="transcript" aria-selected="false">Transcript</a>
              </li>
              <!-- Nav item -->
              <li class="nav-item">
                <a class="nav-link" id="faq-tab" data-toggle="pill" href="#faq" role="tab" aria-controls="faq"
                ...
                <div class="tab-pane fade show active" id="description" role="tabpanel"
                  ...
                  <div class="mb-4">
                    ...
                    <p>
                      ...
                      First, you'll discover the types of applications that can be built with JavaScript, and the
                      platforms they’ll run on.
                    </p>
                    <p>
                      Next, you’ll explore the basics of the language, giving plenty of examples. Lastly, you’ll put
                      your JavaScript knowledge to work and modify a modern, responsive web page. When you’re finished
                      with this course, you’ll have the skills and knowledge in JavaScript to create simple programs,
                    ...
                    <div class="col-12 col-md-6">
                      ...
                      <ul class="list-unstyled">
                        <li class="d-flex align-item-center mb-2">
                          <i class="far fa-check-circle text-success mr-2 lh-lg"></i>
                          <span>
                ...
                <div class="tab-pane fade" id="transcript" role="tabpanel" aria-labelledby="transcript-tab">
                  ...
                  <div>
                    ...
                    <div class="mb-4">
                      <h4>
                        Course Overview
                        <a href="#!" class="ml-2 h4 text-primary">[00:00:00]</a>
                      </h4>
                      <p class="mb-0">
                    ...
                    <div class="mb-4">
                      <h4>
                        Introduction
                        <a href="#!" class="ml-2 h4 text-primary">[00:00:16]</a>
                      </h4>
                      <p>
                    ...
                    <div class="mb-4">
                      <h4>
                        ...
                        <a href="#!" class="ml-2 h4 text-primary">[00:00:37]</a>
                      </h4>
                      <p>
                        We'll dive into GraphQL, the fundamentals of GraphQL. We're only gonna use the pieces of it that
                        we need to build in Gatsby. We're not gonna be doing a deep dive into what GraphQL is or
                    ...
                    <div class="mb-4">
                      <h4>
                        ...
                        <a href="#!" class="ml-2 h4 text-primary">[00:00:54]</a>
                      </h4>
                      <p>
                        We'll dive into GraphQL, the fundamentals of GraphQL. We're only gonna use the pieces of it that
                        we need to build in Gatsby. We're not gonna be doing a deep dive into what GraphQL is or
                    ...
                    <div class="mb-4">
                      <h4>
                        Summary
                        <a href="#!" class="ml-2 h4 text-primary">[00:01:31]</a>
                      </h4>
                      <p>
                        We'll dive into GraphQL, the fundamentals of GraphQL. We're only gonna use the pieces of it that
                        we need to build in Gatsby. We're not gonna be doing a deep dive into what GraphQL is or
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item p-0 bg-transparent">
                  ...
                  <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none py-3 px-4"
                    data-toggle="collapse" href="#courseTwo" role="button" aria-expanded="false"
                    aria-controls="courseTwo">
                    <div class="mr-auto">
                      Course Overview
                      <p class="mb-0 text-muted font-size-xs mt-1 font-weight-normal">14 videos (1 hour and 17 minutes)
                      </p>
                    </div>
                    <!-- Chevron -->
                    ...
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item">
                        <a href="#!"
                          ...
                          <div class="text-truncate">
                            <span class="icon-shape bg-success text-white icon-sm rounded-circle mr-2"><i
                      ...
                      <li class="list-group-item disabled" aria-disabled="true">
                        <a href="#!"
                          class="d-flex justify-content-between align-items-center text-inherit text-decoration-none">
                          <div class="text-truncate">
                            <span class="icon-shape bg-light text-muted icon-sm rounded-circle mr-2"><i
                ...
                <li class="list-group-item p-0">
                  <!-- Toggle -->
                  <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none py-3 px-4"
                    data-toggle="collapse" href="#courseThree" role="button" aria-expanded="false"
                    aria-controls="courseThree">
                    <div class="mr-auto">
                      <!-- Title -->
                      JavaScript Beginning
                      <p class="mb-0 text-muted font-size-xs mt-1 font-weight-normal">6 videos (34 minutes)</p>
                    </div>
                    <!-- Chevron -->
                    <span class="chevron-arrow ml-4">
                      <i class="fe fe-chevron-down font-size-md"></i>
                ...
                <li class="list-group-item p-0">
                  <!-- Toggle -->
                  <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none py-3 px-4"
                    data-toggle="collapse" href="#courseFour" role="button" aria-expanded="false"
                    aria-controls="courseFour">
                    <div class="mr-auto">
                      <!-- Title -->
                      Variables and Constants
                      <p class="mb-0 text-muted font-size-xs mt-1 font-weight-normal">6 videos (3 hour and 24 minutes)
                      </p>
                    </div>
                    <!-- Chevron -->
                    <span class="chevron-arrow ml-4">
                ...
                <li class="list-group-item p-0">
                  <!-- Toggle -->
                  <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none py-3 px-4"
                    data-toggle="collapse" href="#courseSix" role="button" aria-expanded="false"
                    aria-controls="courseSix">
                    <div class="mr-auto">
                      <!-- Title -->
                      Program Flow
                      <p class="mb-0 text-muted font-size-xs mt-1 font-weight-normal">5 videos (2 hour and 10 minutes)
                      </p>
                    </div>
                    <!-- Chevron -->
                    <span class="chevron-arrow ml-4">
                ...
                <li class="list-group-item p-0">
                  <!-- Toggle -->
                  <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none py-3 px-4"
                    data-toggle="collapse" href="#courseSeven" role="button" aria-expanded="false"
                    aria-controls="courseSeven">
                    <div class="mr-auto">
                      <!-- Title -->
                      Functions
                      <p class="mb-0 text-muted font-size-xs mt-1 font-weight-normal">7 videos (4 hour and 38 minutes)
                      </p>
                    </div>
                    <!-- Chevron -->
                    <span class="chevron-arrow ml-4">
                ...
                <li class="list-group-item p-0">
                  <!-- Toggle -->
                  <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none py-3 px-4"
                    data-toggle="collapse" href="#courseEight" role="button" aria-expanded="false"
                    aria-controls="courseEight">
                    <div class="mr-auto">
                      <!-- Title -->
                      Objects and the DOM
                      <p class="mb-0 text-muted font-size-xs mt-1 font-weight-normal">4 videos (2 hour and 10 minutes)
                      </p>
                    </div>
                    <!-- Chevron -->
                    <span class="chevron-arrow ml-4">
                ...
                <li class="list-group-item p-0">
                  <!-- Toggle -->
                  <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none py-3 px-4"
                    data-toggle="collapse" href="#courseNine" role="button" aria-expanded="false"
                    aria-controls="courseNine">
                    <div class="mr-auto">
                      <!-- Title -->
                      Arrays
                      <p class="mb-0 text-muted font-size-xs mt-1 font-weight-normal">3 videos (1 hour and 5 minutes)
                      </p>
                    </div>
                    <!-- Chevron -->
                    <span class="chevron-arrow ml-4">
                ...
                <li class="list-group-item p-0">
                  <!-- Toggle -->
                  <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none py-3 px-4"
                    data-toggle="collapse" href="#courseTen" role="button" aria-expanded="false"
                    aria-controls="courseTen">
                    <div class="mr-auto">
                      <!-- Title -->
                      Scope and Hoisting
                      <p class="mb-0 text-muted font-size-xs mt-1 font-weight-normal">2 videos (3 hour and 15 minutes)
                      </p>
                    </div>
                    <!-- Chevron -->
                    <span class="chevron-arrow ml-4">
                ...
                <li class="list-group-item p-0 bg-transparent">
                  <!-- Toggle -->
                  <a class="h4 mb-0 d-flex align-items-center text-inherit text-decoration-none py-3 px-4"
                    data-toggle="collapse" href="#courseEleven" role="button" aria-expanded="false"
                    aria-controls="courseEleven">
                    <div class="mr-auto">
                      <!-- Title -->
                      Summary
                      <p class="mb-0 text-muted font-size-xs mt-1 font-weight-normal">1 videos (5 minutes)</p>
                    </div>
                    <!-- Chevron -->
                    <span class="chevron-arrow ml-4">
                      <i class="fe fe-chevron-down font-size-md"></i>
                  ...
                  <div class="collapse" id="courseEleven" data-parent="#courseAccordion">
                    <div class="px-4 pt-0 pb-2">
                      <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae esse velit eos sunt ab
                        inventore est tenetur blanditiis? Voluptas eius molestiae ad itaque tempora nobis minima eveniet
                        aperiam molestias, maiores natus expedita dolores ea non possimus magnam corrupt i quas rem unde
                        quo enim porro culpa! Quaerat veritatis veniam corrupti iusto.
                      </p>
                    </div>
                  </div>
                </li>
