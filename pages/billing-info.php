...
<!-- Mirrored from codescandy.com/geeks/pages/billing-info.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:25 GMT -->
<head>
	<!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
	<title>Billing Info | Geeks - Academy Admin Template</title>
</head>
									...
									<div class="row">
										<div class="col">
											<div class="custom-control custom-radio">
												...
												<label class="custom-control-label" for="customRadio1"><span class="h4">Billing Address
														#1</span>
													<span class="d-block">1901 Thornridge Cir. Shiloh, Hawaii 81063</span></label>
											</div>
										</div>
										<div class="col-auto">
											<a href="#!" class="btn btn-outline-white btn-sm">Edit Address</a>
										</div>
									</div>
								</li>
								<!-- List group item -->
									...
									<div class="row">
										<div class="col">
											<div class="custom-control custom-radio">
												...
												<label class="custom-control-label" for="customRadio2"><span class="h4">Billing Address
														#2</span>
													<span class="d-block">1901 Thornridge Cir. Shiloh, Hawaii 81063</span></label>
											</div>
										</div>
