...
<!-- Mirrored from codescandy.com/geeks/pages/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:06 GMT -->
<head>
  <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
  ...
  <title>About us | Geeks - Academy Admin Template </title>
  <style>
    .h-250rem {
    height: 15.625rem;}
    .bg-img-hero {
		  ...
		  <ul class="navbar-nav">
			 ...
			 <li class="nav-item dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="navbarLanding">
				   ...
				   <li>
					  <a href="landings/landing-courses.html" class="dropdown-item">
					 Courses
					  </a>
				   </li>
				   <li>
					<a href="landings/course-lead.html" class="dropdown-item">
				   Lead Course
					</a>
				 </li>
    ...
    <div class="container">
      <div class="row">
        <div class="offset-lg-2 col-lg-8 col-md-12 col-12 mb-12">
          <!-- caption-->
          <h1 class="display-2 font-weight-bold mb-3">Hi there, we’re <span class="text-primary">Geeks</span></h1>
          <!-- para -->
          ...
          <p class="mb-0 h4 text-body lh-lg">Geeks provide clean and consistent page designs to help you to create beautiful
      ...
      <div class="gallery mb-12">
       <!-- gallery-item -->
        <figure class="gallery__item gallery__item--1 mb-0">
          <img src="../assets/images/about/geeksui-img-1.jpg" alt="Gallery image 1" class="gallery__img rounded-lg">
        </figure>
         <!-- gallery-item -->
        <figure class="gallery__item gallery__item--2 mb-0">
          <img src="../assets/images/about/geeksui-img-2.jpg" alt="Gallery image 2" class="gallery__img rounded-lg">
        </figure>
         <!-- gallery-item -->
        <figure class="gallery__item gallery__item--3 mb-0">
          <img src="../assets/images/about/geeksui-img-3.jpg" alt="Gallery image 3" class="gallery__img rounded-lg">
        </figure>
         <!-- gallery-item -->
        <figure class="gallery__item gallery__item--4 mb-0">
          <img src="../assets/images/about/geeksui-img-4.jpg" alt="Gallery image 4" class="gallery__img rounded-lg">
        </figure>
          <!-- gallery-item -->
        <figure class="gallery__item gallery__item--5 mb-0">
          <img src="../assets/images/about/geeksui-img-5.jpg" alt="Gallery image 5" class="gallery__img rounded-lg">
        </figure>
         <!-- gallery-item -->
        <figure class="gallery__item gallery__item--6 mb-0">
          <img src="../assets/images/about/geeksui-img-6.jpg" alt="Gallery image 6" class="gallery__img rounded-lg">
        </figure>
      </div>
      <div class="row">
         <!-- row -->
        <div class="col-md-6 offset-right-md-6">
           <!-- heading -->
          <h1 class="display-4 font-weight-bold mb-3">Our global reach</h1>
           <!-- para -->
        ...
        <div class="col-lg-3 col-md-6 col-6">
          ...
          <div class="border-top pt-4 mt-6 mb-5">
            <h1 class="display-3 font-weight-bold mb-0">20M</h1>
        ...
        <div class="col-lg-3 col-md-6 col-6">
          <!-- counter -->
          <div class="border-top pt-4 mt-6 mb-5">
            <h1 class="display-3 font-weight-bold mb-0">57K</h1>
        ...
        <div class="col-lg-3 col-md-6 col-6">
          <!-- counter -->
          <div class="border-top pt-4 mt-6 mb-5">
            <h1 class="display-3 font-weight-bold mb-0">21K</h1>
        ...
        <div class="col-lg-3 col-md-6 col-6">
          <!-- counter -->
          <div class="border-top pt-4 mt-6 mb-5">
            <h1 class="display-3 font-weight-bold mb-0">380M</h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 offset-right-md-6 col-12 mb-6">
          <!-- caption -->
          <h2 class="display-4 mb-3 font-weight-bold">Our core values</h2>
          <p class="lead">Our core values are the fundamental beliefs of a person or organization geeks academy. We help
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 offset-right-md-6 col-12 mb-10">
           <!-- heading -->
          <h2 class="display-4 mb-3 font-weight-bold">Our Team</h2>
           <!-- lead -->
      ...
      <div class="row">
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
             <!-- avatar -->
            <img src="../assets/images/avatar/avatar-1.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="one">
             <!-- text -->
            <div id="one" class="d-none">
              <h4 class="mb-0 font-weight-bold">Paul Haney</h4>
              <span>CEO </span>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="../assets/images/avatar/avatar-2.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="two">
            <!-- text -->
            <div id="two" class="d-none">
              <h4 class="mb-0 font-weight-bold">Gail Lanier</h4>
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="../assets/images/avatar/avatar-3.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="three">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="../assets/images/avatar/avatar-4.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="four">
            <!-- text -->
            <div id="four" class="d-none">
              <h4 class="mb-0 font-weight-bold">Mary Holler</h4>
              <span>Sales</span>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="../assets/images/avatar/avatar-5.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="five">
            <!-- text -->
            <div id="five" class="d-none">
              <h4 class="mb-0 font-weight-bold">Gilbert Farr</h4>
              <span>Oprator </span>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="../assets/images/avatar/avatar-6.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="six">
            <!-- text -->
            <div id="six" class="d-none">
              <h4 class="mb-0 font-weight-bold">Charlie Holland</h4>
              <span>Designer </span>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="../assets/images/avatar/avatar-7.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="seven">
            <!-- text -->
            <div id="seven" class="d-none">
              <h4 class="mb-0 font-weight-bold">James Butler</h4>
              <span>Developer </span>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="../assets/images/avatar/avatar-8.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="eight">
            <!-- text -->
            <div id="eight" class="d-none">
              <h4 class="mb-0 font-weight-bold">Richard Lane</h4>
              <span>Insight </span>
            </div>
          </div>
        </div>
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="../assets/images/avatar/avatar-9.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="eleven">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="../assets/images/avatar/avatar-10.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="twelve">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="../assets/images/avatar/avatar-11.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="thirteen">
            <!-- text -->
        ...
        <div class="col-md-2 col-3">
          <div class="p-xl-5 p-lg-3 mb-3 mb-lg-0">
            <!-- avatar -->
            <img src="../assets/images/avatar/avatar-12.jpg" alt="" class="imgtooltip img-fluid rounded-circle" data-template="fourteen">
            <!-- text -->
      ...
      <div class="row align-items-center no-gutters">
        <div class="col-xl-6 col-lg-6 col-md-12">
          ...
          <div class="pt-6 pt-lg-0">
            <h1 class="text-white display-4 font-weight-bold pr-lg-8">Join the Geeks team & shape the future of design
            </h1>
            <!-- text -->
...
<!-- Mirrored from codescandy.com/geeks/pages/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:09 GMT -->
</html>