...
<!-- Mirrored from codescandy.com/geeks/pages/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:04 GMT -->
<head>
  <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
  <title>Blog Single | Geeks - Academy Admin Template</title>
</head>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-8 col-lg-8 col-md-12 col-12 mb-2">
            <div class="text-center mb-4">
              <a href="#!" class="font-size-sm font-weight-semi-bold d-block mb-4 text-primary">Courses</a>
              <h1 class="display-3 font-weight-bold mb-4">Getting Started The Web Development JavaScript in 2020</h1>
            ...
            <div class="d-flex justify-content-between align-items-center mb-5">
              ...
              <div>
                ...
                <a href="#!" class="mr-2 text-muted"><i class="fab fa-facebook"></i></a>
                <a href="#!" class="mr-2 text-muted"><i class="fab fa-twitter"></i></a>
                <a href="#!" class="mr-2 text-muted "><i class="fab fa-linkedin"></i></a>
              </div>
            </div>
          </div>
        </div>
        <div class="row justify-content-center">
          ...
          <div class="col-xl-10 col-lg-10 col-md-12 col-12 mb-6">
            <img src="../assets/images/blog/blogpost-1.jpg" alt="" class="img-fluid rounded-lg">
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-xl-8 col-lg-8 col-md-12 col-12 mb-2">
              ...
              <div>
                <div class="mb-4">
                  <p class="lead text-dark">
                    Design Systems for Developers Geeks a modern, clean and accessibility oriented design system for
                    developing fast and powerful web interfaces.
                  </p>
                  <p>
                    Condimentum leo utipsum euismod feugiatn elntum sapiennonser variusmi elementum necunc elementum
                    velitnon tortor convallis variusa placerat nequhse. Mauris varius ullamcorper tincidsellus egestas
                    innisivel sollicituullam feugiate facilisis ones
                    Suspendisse blandit sedtincinean.
                  </p>
                  <p>
                    Mauris varius ullamcorper tincidsellus egestas innisivel sollicituullam feugiate facilisis ones
                    velleo
                    finibus maximus nequsese sedmattis auspendisse
                ...
                <blockquote class="blockquote text-center ">
                  <p class="text-primary font-italic font-weight-semi-bold lh-lg h1 px-2 px-lg-14">
                ...
                <div class="mb-5">
                  ...
                  <p>
                    ...
                    get started.
                  	...
                  	<!-- Img  -->
                  <img src="../assets/images/blog/center-img.jpg" alt="" class="img-fluid rounded-lg mb-2 mt-3 w-100" />
                  <span>The image above happens to be centered.</span>
                  <div class="d-flex align-items-start mt-4">
                    	<!-- Img  -->
                    <img src="../assets/images/blog/left-img.jpg" alt=""
                      class="img-fluid mr-4 rounded-lg d-none d-lg-block d-md-block" />
                    <div>
                      <p>
                ...
                <div class="mb-4">
                  <div class="d-flex align-items-start">
                    ...
                    <img src="../assets/images/blog/right-img.jpg" alt=" "
                      class="img-fluid ml-4 rounded-lg  d-none d-lg-block d-md-block" />
                  </div>
                </div>
                <div class="mb-4 ">
                  <p class="mb-0">
            ...
            <div class="py-12">
              <div class="text-center mb-6">
                <h2 class="display-4 font-weight-bold">Sign up for our Newsletter</h2>
        ...
        <div class="row">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-12">
            ...
            <div class="card mb-4 shadow-lg ">
              ...
              <!-- Card body -->
              <div class="card-body">
                <a href="#!" class="font-size-sm font-weight-semi-bold d-block mb-3 text-warning">Warning</a>
                <h3><a href="blog-single.html" class="text-inherit">
...
<!-- Mirrored from codescandy.com/geeks/pages/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:06 GMT -->
</html>