...
<!-- Mirrored from codescandy.com/geeks/pages/invoice-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:26 GMT -->
<head>
  <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
  <title>Invoice Details | Geeks - Academy Admin Template</title>
</head>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
          ...
          <div
            ...
            <div>
              <a href="dashboard-student.html" class="btn btn-outline-primary btn-sm d-none d-md-block">Go
                to Dashboard</a>
            </div>
          </div>
        </div>
            ...
            <div class="collapse navbar-collapse" id="sidenav">
              <div class="navbar-nav flex-column">
                ...
                <ul class="list-unstyled ml-n2 mb-4">
                  <!-- Nav item -->
                  <li class="nav-item">
                    <a class="nav-link" href="student-subscriptions.html"><i class="fe fe-calendar mr-2 "></i>My
                      Subscriptions</a>
                  </li>
                  <!-- Nav item -->
                  <li class="nav-item">
                    <a class="nav-link" href="billing-info.html"><i class="fe fe-credit-card mr-2 "></i>Billing
                      Info</a>
                  </li>
                  <!-- Nav item -->
                  <li class="nav-item ">
                    <a class="nav-link" href="payment-method.html"><i class="fe fe-credit-card mr-2 "></i>Payment</a>
                  </li>
                  <!-- Nav item -->
                  <li class="nav-item active">
                    <a class="nav-link" href="invoice.html"><i class="fe fe-clipboard mr-2 "></i>Invoice</a>
                  </li>
                </ul>
                ...
                <ul class="list-unstyled ml-n2 mb-0">
                  <!-- Nav item -->
                  <li class="nav-item ">
                    <a class="nav-link" href="profile-edit.html"><i class="fe fe-settings  mr-2"></i>Edit Profile</a>
                  </li>
                  <!-- Nav item -->
                  <li class="nav-item">
                    <a class="nav-link" href="security.html"><i class="fe fe-user  mr-2"></i>Security</a>
                  </li>
                  <!-- Nav item -->
                  <li class="nav-item">
                    <a class="nav-link" href="social-profile.html"><i class="fe fe-refresh-cw  mr-2"></i>Social
                      Profiles</a>
                  </li>
                  <!-- Nav item -->
                  <li class="nav-item">
                    <a class="nav-link" href="notifications.html"><i class="fe fe-bell  mr-2"></i>Notifications</a>
                  </li>
                  <!-- Nav item -->
                  <li class="nav-item">
                    <a class="nav-link" href="profile-privacy.html"><i class="fe fe-lock  mr-2"></i>Profile Privacy</a>
                  </li>
                  <!-- Nav item -->
                  <li class="nav-item ">
                    <a class="nav-link" href="delete-profile.html"><i class="fe fe-trash  mr-2"></i>Delete Profile</a>
                  </li>
                  	<!-- Nav item -->
									<li class="nav-item">
