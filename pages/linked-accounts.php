...
<!-- Mirrored from codescandy.com/geeks/pages/linked-accounts.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:27 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
    <title>Linked Accounts | Geeks - Academy Admin Template</title>
</head>
                    ...
                    <div class="d-flex align-items-end justify-content-between bg-white px-4 pt-2 pb-4 rounded-none rounded-bottom shadow-sm">
                        <div class="d-flex align-items-center">
                            <div class="mr-2 position-relative d-flex justify-content-end align-items-end mt-n5">
                                <img src="../assets/images/avatar/avatar-3.jpg" class="avatar-xl rounded-circle border-width-4 border-white" alt="" />
                            </div>
                            <div class="lh-1">
                                <h2 class="mb-0">
                                    Stella Flores
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-5 d-md-flex">
                                <!-- facebook -->
                                <div>
                                    <i class="mdi mdi-facebook h1 mr-3 color-facebook"></i>
                                </div>
                                <div class="mt-1">
                            ...
                            <div class="mb-5 d-md-flex border-top pt-5">
                                ...
                                <div>
                                    <i class="mdi mdi-google color-google h1 mr-3"></i>
                                </div>
                                <div class="mt-1">
                            ...
                            <div class="mb-5 d-md-flex border-top pt-5">
                                ...
                                <div>
                                    <i class="mdi mdi-github color-github h1 mr-3"></i>
                                </div>
                                <div class="mt-1">
                            ...
                            <div class="mb-5 d-md-flex border-top pt-5">
                                ...
                                <div>
                                    <i class="mdi mdi-twitter color-twitter h1 mr-3"></i>
                                </div>
                                <div class="mt-1">
