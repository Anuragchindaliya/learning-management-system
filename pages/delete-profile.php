...
<!-- Mirrored from codescandy.com/geeks/pages/delete-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:27 GMT -->
<head>
	<!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
	<title>Delete Profile | Geeks - Academy Admin Template</title>
</head>
				...
				<div class="col-lg-9 col-md-8 col-12">
					...
					<div class="card">
						...
						<div class="card-body p-4">
							...
							<a href="../index.html" class="btn btn-outline-danger btn-sm">Close My Account</a>
						</div>
					</div>
				</div>
			</div>
