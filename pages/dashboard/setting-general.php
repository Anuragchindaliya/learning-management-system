...
<!-- Mirrored from codescandy.com/geeks/pages/dashboard/setting-general.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:33:17 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../../assets/css/theme.min.css">
    <title>General Setting | Geeks - Academy Admin Template</title>
</head>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="navSiteSetting" class="collapse show" data-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <!-- Nav item -->
                                <li class="nav-item">
                                    <a class="nav-link active" href="setting-general.html">General
									</a>
                                </li>
                                <!-- Nav item -->
                                <li class="nav-item">
                    ...
                    <div class="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 col-md-12 col-12">
                        <div class="border-bottom pb-4 mb-4">
                            <div class="mb-2 mb-lg-0">
                                <h1 class="mb-1 h2 font-weight-bold">General Setting</h1>
                                <!-- Breadcrumb -->
