...
<!-- Mirrored from codescandy.com/geeks/pages/dashboard/admin-instructor.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:33:05 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../../assets/css/theme.min.css">
    <title>Instructor | Geeks - Academy Admin Template</title>
</head>
...
<body>
    ...
    <div id="db-wrapper">
        ...
        Analytics <span class="badge badge-warning ml-2">New</span>
                    ...
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class="nav-link active " href="#!" data-toggle="collapse" data-target="#navProfile" aria-expanded="true" aria-controls="navProfile">
                            <i class="nav-icon fe fe-user mr-2"></i>User
                        </a>
                        <div id="navProfile" class="collapse show" data-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link active" href="admin-instructor.html">Instructor
                  </a>
                                </li>
                                <li class="nav-item ">
                        ...
                        <div class="border-bottom pb-4 mb-4 d-flex justify-content-between align-items-center">
                            <div class="mb-2 mb-lg-0">
                                <h1 class="mb-1 h2 font-weight-bold">
                                    Instructor
                                    <span class="font-size-sm text-muted">(12,105)</span>
                                </h1>
                                <!-- Breadcrumb  -->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList">
                                                ...
                                                <tr>
                                                    <td class="align-middle border-top-0">
                                                        <div class="d-flex align-items-center">
                                                            <img src="../../assets/images/avatar/avatar-12.jpg" alt="" class="rounded-circle avatar-md mr-2" />
                                                    ...
                                                    <td class="align-middle border-top-0">
                                                        <a href="#!" class="text-muted" data-toggle="tooltip" data-placement="top" title="Message"><i class="fe fe-mail"></i></a>
                                                    </td>
                                                    <td class="align-middle border-top-0">
                                                        <a href="#!" class="text-muted" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fe fe-trash"></i></a>
                                                    </td>
                                      ...
                                      class="fe fe-trash dropdown-item-icon"></i>Remove</a>
                                                ...
                                                <tr>
                                                    <td class="align-middle">
                                                        <div class="d-flex align-items-center">
                                                            <img src="../../assets/images/avatar/avatar-13.jpg" alt="" class="rounded-circle avatar-md mr-2" />
                                                    ...
                                                    <td class="align-middle">6 July, 2020</td>
                                                    <td class="align-middle">26,060</td>
                                ...
                                <a class="text-muted text-decoration-none" href="#!" role="button" id="courseDropdown1"
                                  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <i class="fe fe-more-vertical"></i></a>
                                <span class="dropdown-menu" aria-labelledby="courseDropdown1"><span
                                    class="dropdown-header">Settings</span>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-edit dropdown-item-icon"></i>Edit</a>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-trash dropdown-item-icon"></i>Remove</a>
                                                ...
                                                <tr>
                                                    <td class="align-middle">
                                                        <div class="d-flex align-items-center">
                                                            <img src="../../assets/images/avatar/avatar-17.jpg" alt="" class="rounded-circle avatar-md mr-2" />
                                                    ...
                                                    <td class="align-middle">12 June, 2020</td>
                                                    <td class="align-middle">8,234</td>
                                                    <td class="align-middle text-warning">
                                                        4.5 <span class="mdi mdi-star"></span>
                                                    </td>
                                                    <td class="align-middle">
                                ...
                                <a class="text-muted text-decoration-none" href="#!" role="button" id="courseDropdown2"
                                  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <i class="fe fe-more-vertical"></i></a>
                                <span class="dropdown-menu" aria-labelledby="courseDropdown2"><span
                                    class="dropdown-header">Settings</span>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-edit dropdown-item-icon"></i>Edit</a>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-trash dropdown-item-icon"></i>Remove</a>
                                                ...
                                                <tr>
                                                    <td class="align-middle">
                                                        <div class="d-flex align-items-center">
                                                            <img src="../../assets/images/avatar/avatar-14.jpg" alt="" class="rounded-circle avatar-md mr-2" />
                                                            <h5 class="mb-0">Jacob Jones</h5>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle">Bootstrap Expert</td>
                                                    <td class="align-middle">7 Courses</td>
                                                    <td class="align-middle">2 July, 2020</td>
                                ...
                                <span class="dropdown-menu" aria-labelledby="courseDropdown3"><span
                                    class="dropdown-header">Settings</span>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-edit dropdown-item-icon"></i>Edit</a>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-trash dropdown-item-icon"></i>Remove</a>
                                                ...
                                                <tr>
                                                    <td class="align-middle">
                                                        <div class="d-flex align-items-center">
                                                            <img src="../../assets/images/avatar/avatar-15.jpg" alt="" class="rounded-circle avatar-md mr-2" />
                                                            <h5 class="mb-0">Kristin Watson</h5>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle">Web Development</td>
                                                    <td class="align-middle">5 Courses</td>
                                                    <td class="align-middle">1 July, 2020</td>
                                ...
                                <span class="dropdown-menu" aria-labelledby="courseDropdown4"><span
                                    class="dropdown-header">Settings</span>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-edit dropdown-item-icon"></i>Edit</a>
                                                        <a class="dropdown-item" href="#!"><i
                                ...
                                <span class="dropdown-menu" aria-labelledby="courseDropdown5"><span
                                    class="dropdown-header">Settings</span>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-edit dropdown-item-icon"></i>Edit</a>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-trash dropdown-item-icon"></i>Remove</a>
                                                ...
                                                <tr>
                                                    <td class="align-middle">
                                                        <div class="d-flex align-items-center">
                                                            <img src="../../assets/images/avatar/avatar-16.jpg" alt="" class="rounded-circle avatar-md mr-2" />
                                ...
                                <span class="dropdown-menu" aria-labelledby="courseDropdown6"><span
                                    class="dropdown-header">Settings</span>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-edit dropdown-item-icon"></i>Edit</a>
                                                        <a class="dropdown-item" href="#!"><i
                                ...
                                <span class="dropdown-menu" aria-labelledby="courseDropdown7"><span
                                    class="dropdown-header">Settings</span>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-edit dropdown-item-icon"></i>Edit</a>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-trash dropdown-item-icon"></i>Remove</a>
                                                ...
                                                <tr class="border-bottom">
                                                    <td class="align-middle">
                                                        <div class="d-flex align-items-center">
                                                            <img src="../../assets/images/avatar/avatar-18.jpg" alt="" class="rounded-circle avatar-md mr-2" />
                                                    ...
                                                    <td class="align-middle">9 Courses</td>
                                                    <td class="align-middle">8 June, 2020</td>
                                                    <td class="align-middle">3,242</td>
                                                    <td class="align-middle text-warning">
                                                    ...
                                                    <td class="text-muted px-4 align-middle">
                                                        <span class="dropdown">
                                <a class="text-muted text-decoration-none" href="#!" role="button" id="courseDropdown8"
                                  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  <i class="fe fe-more-vertical"></i>
                                </a>
                                <span class="dropdown-menu" aria-labelledby="courseDropdown8"><span
                                    class="dropdown-header">Settings</span>
                                                        <a class="dropdown-item" href="#!"><i
                                      class="fe fe-edit dropdown-item-icon"></i>Edit</a>
                                                        <a class="dropdown-item" href="#!"><i
...
<!-- Mirrored from codescandy.com/geeks/pages/dashboard/admin-instructor.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:33:10 GMT -->
</html>