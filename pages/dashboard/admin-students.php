...
<!-- Mirrored from codescandy.com/geeks/pages/dashboard/admin-students.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:33:10 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8">
                        ...
                        <li class="dropdown stopevent">
                          ...
                          class="fe fe-settings mr-1"></i></span></a>
                                ...
                                <div class="border-top px-3 pt-3 pb-0">
                                    <a href="notification-history.html" class="text-link font-weight-semi-bold">See all Notifications</a>
                                </div>
                            </div>
                        </li>
                        <!-- Dropdown  -->
                                                ...
                                                <tr>
                                                    <td class="align-middle border-top-0">
                                                        <div class="d-flex align-items-center">
                                                            <div class="position-relative">
                                                                <img src="../../assets/images/avatar/avatar-11.jpg" alt="" class="rounded-circle avatar-md mr-2" />
                                                    ...
                                                    <td class="align-middle border-top-0">
                                                        <a href="#!" class="fe fe-mail text-muted" data-toggle="tooltip" data-placement="top" title="Message">
                                                        </a>
                                                    </td>
                                                    <td class="align-middle border-top-0">
