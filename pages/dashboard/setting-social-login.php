...
<!-- Mirrored from codescandy.com/geeks/pages/dashboard/setting-social-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:33:17 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../../assets/css/theme.min.css">
    <title>Social Login Setting | Geeks - Academy Admin Template</title>
</head>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="navSiteSetting" class="collapse show" data-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="setting-social-login.html"> Social Login
									</a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-12 col-md-12 col-12">
                        ...
                        <div class="card mb-4 ">
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">
                                    <i class="mdi mdi-facebook text-primary mdi-24px align-middle mr-2"></i>Facebook Login Settings
                                </h4>
                                <!-- Custom Control -->
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-12">
                        ...
                        <div class="card mb-4 ">
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">
                                    <i class="mdi mdi-twitter text-primary mdi-24px align-middle mr-2"></i>Twitter Login Settings
                                </h4>
                                <!-- Custom control -->
                                <div class="custom-control custom-switch">
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-12">
                        ...
                        <div class="card mb-4 ">
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">
                                    <i class="mdi mdi-google text-primary mdi-24px align-middle mr-2"></i>Google Login Settings
                                </h4>
                                <!-- Custom Control -->
                                <div class="custom-control custom-switch">
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-12">
                        ...
                        <div class="card mb-4 ">
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">
                                    <i class="mdi mdi-linkedin text-primary mdi-24px align-middle mr-2"></i>LinkedIn Login API Settings
                                </h4>
                                <!-- Custom Control -->
                                <div class="custom-control custom-switch">
