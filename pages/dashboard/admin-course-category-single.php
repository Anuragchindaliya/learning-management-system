...
<!-- Mirrored from codescandy.com/geeks/pages/dashboard/admin-course-category-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:33:05 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="navCourses" class="collapse show" data-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="admin-course-category-single.html">
                    Category Single</a>
                                </li>
                            </ul>
                        </div>
