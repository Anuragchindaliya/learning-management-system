...
<!-- Mirrored from codescandy.com/geeks/pages/dashboard/admin-cms-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:33:10 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../../assets/css/theme.min.css">
    <title>CMS Post | Geeks - Academy Admin Template</title>
</head>
...
<body>
    ...
    <div id="db-wrapper">
        ...
        Analytics <span class="badge badge-warning ml-2">New</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#!" data-toggle="collapse" data-target="#navCMS" aria-expanded="true" aria-controls="navCMS">
                        ...
                        <div id="navCMS" class="collapse show" data-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="admin-cms-post.html">All Post
                  </a>
                                </li>
                                <li class="nav-item">
...
<!-- Mirrored from codescandy.com/geeks/pages/dashboard/admin-cms-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:33:11 GMT -->
</html>