...
<!-- Mirrored from codescandy.com/geeks/pages/dashboard/notification-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:12:50 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../../assets/css/theme.min.css">
    <title>Notification History | Geeks - Academy Admin Template</title>
</head>
    ...
    <div id="db-wrapper">
        ...
        <nav class="navbar-vertical navbar">
          ...
          Analytics <span class="badge badge-warning ml-2">New</span>
                    ...
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class="nav-link" href="#!" data-toggle="collapse" data-target="#navAuthentication" aria-expanded="true" aria-controls="navAuthentication">
                            <i class="nav-icon fe fe-lock mr-2"></i>Authentication
                        </a>
                        <div id="navAuthentication" class="collapse show" data-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="notification-history.html">
										Notifications</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class="nav-link active" href="#!" data-toggle="collapse" data-target="#navSiteSetting" aria-expanded="false" aria-controls="navSiteSetting">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-3">
                                                    <p class="mb-0">
                                                        <span class="font-weight-bold mb-0 h5">Kristin
                                Watson:</span> like your comment on course Javascript Introduction!
                                                    </p>
                                                    <span class="font-size-xs text-muted">
                              <span><span class="fe fe-thumbs-up text-success mr-1"></span>2 hours ago,</span>
                                                    <span class="ml-1">2:19 PM</span>
                                        ...
                                        <div class="col-auto text-center">
                                            <button class="badge-dot badge-info border-0" data-toggle="tooltip" data-placement="top" title="" data-original-title="Mark as read"></button>
                                            <div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-3">
                                                    <p class="mb-0">
                                                        <span class="font-weight-bold mb-0 h5">Brooklyn
                                Simmons:</span> Just launched a new Courses React for Beginner.
                                                    </p>
                                                    <span class="font-size-xs text-muted">
                              <span><span class="fe fe-thumbs-up text-success mr-1"></span>Oct 9,
                                                    </span>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-3">
                                                    <p class="mb-0">
                                                        <span class="font-weight-bold mb-0 h5">Jenny Wilson:</span> Krisitn Watsan like your comment on course Javascript Introduction!
                                                    </p>
                                                    <span class="font-size-xs text-muted">
                              <span><span class="fe fe-thumbs-up text-info mr-1"></span>Oct 9,
                                                    </span>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-3">
                                                    <p class="mb-0">
                                                        <span class="font-weight-bold mb-0 h5">Sina Ray:</span> You earn new certificate for complete the Javascript Beginner course.
                                                    </p>
                                                    <span class="font-size-xs text-muted">
                              <span><span class="fe fe-award text-warning mr-1"></span>Oct 9,
                                                    </span>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-3">
                                                    <p class="mb-0">
                                                        <span class="font-weight-bold mb-0 h5">Nikolas Howe:</span> reply on your comment for
                                                        <a href="#!">Become a Product Manager | Learn the Skills
                              </a>
                                                    </p>
                                                    <span class="font-size-xs text-muted">
                              <span><span class="fe fe-message-square text-info mr-1"></span>Oct 9,
                                                    </span>
                                                    <span class="ml-1">2 PM</span>
                                                    </span>
                                                </div>
                                            </div>
                                            <a class="stretched-link" href="#!"></a>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-3">
                                                    <p class="mb-0">
                                                        <span class="font-weight-bold mb-0 h5">Jadyn Johnson:</span> reply on your comment for
                                                        <a href="#!">The Web Developer Bootcamp 2020
                              </a>
                                                    </p>
                                                    <span class="font-size-xs text-muted">
                              <span><span class="fe fe-message-square text-info mr-1"></span>Oct 9,
                                                    </span>
                                                    <span class="ml-1">2.10 PM</span>
                                                    </span>
                                                </div>
                                            </div>
                                            <a class="stretched-link" href="#!"></a>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-3">
                                                    <p class="mb-0">
                                                        <span class="font-weight-bold mb-0 h5">Jenny Wilson:</span> reply on your comment for
                                                        <a href="#!">
                                The Complete Front End Developer in 2021: Zero
                                to Mastery
                              </a>
                                                    </p>
                                                    <span class="font-size-xs text-muted">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-3">
                                                    <p class="mb-0">
                                                        <span class="font-weight-bold mb-0 h5">Bobbie
                                Koelpin:</span> reply on your comment for
                                                        <a href="#!">Ultimate Web Designer & Developer Course | 20
                                Projects
                              </a>
                                                    </p>
                                                    <span class="font-size-xs text-muted">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-3">
                                                    <p class="mb-0">
                                                        <span class="font-weight-bold mb-0 h5">Brendan
                                Hammes:</span> your earn new certificate for learn courses Java Script Beginner.
                                                    </p>
                                                    <span class="font-size-xs text-muted">
                              <span><span class="fe fe-award text-warning mr-1"></span>Oct 9,
                                                    </span>
                                                    <span class="ml-1">3 hours ago</span>
                                                    </span>
                                                </div>
                                            </div>
                                            <a class="stretched-link" href="#!"></a>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-3">
                                                    <p class="mb-0">
                                                        <span class="font-weight-bold mb-0 h5">Margarita
                                Heathcote:</span> like your comment Integer id mauris vulputate, posuere dui ege course.
...
<!-- Mirrored from codescandy.com/geeks/pages/dashboard/notification-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:13:00 GMT -->
</html>