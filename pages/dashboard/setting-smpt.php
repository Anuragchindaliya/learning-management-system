...
<!-- Mirrored from codescandy.com/geeks/pages/dashboard/setting-smpt.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:33:17 GMT -->
<head>
    <!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../../assets/css/theme.min.css">
    ...
    <title>Server Settings | Geeks - Academy Admin Template</title>
    ...
    <div id="db-wrapper">
        ...
        <nav class="navbar-vertical navbar">
          ...
          Analytics <span class="badge badge-warning ml-2">New</span>
                    ...
                    <!-- Nav item -->
                    <li class="nav-item">
                        <a class="nav-link active" href="#!" data-toggle="collapse" data-target="#navSiteSetting" aria-expanded="true" aria-controls="navSiteSetting">
                            <i class="nav-icon fe fe-settings mr-2"></i>Site Setting
                        </a>
                        <div id="navSiteSetting" class="collapse show" data-parent="#sideNavbar">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="setting-smpt.html"> SMPT
                  </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row">
                                        ...
                                        <!-- Mail driver -->
                                        <div class="form-group col-12 col-md-12 col-lg-6">
                                            <label for="mailDriver" class="form-label">Mail Driver (SMTP, Mail)<span
                          class="text-danger">*</span> </label>
                                            <input class="form-control" id="mailDriver" placeholder="e.g.smtp,gmail.com" type="text" required />
                                        </div>
                                        <!-- Username -->
                                        <div class="form-group col-12 col-md-12 col-lg-6">
                                            <label for="userName" class="form-label">Mail Username<span class="text-danger">*</span>
                        (info@geeksuidesign.com) </label>
                                        ...
                                        <!-- Password -->
                                        <div class="form-group col-12 col-md-12 col-lg-6">
                                            <label for="mailPassword" class="form-label">Mail Password<span class="text-danger">*</span>
                      </label>
                                            <input class="form-control" id="mailPassword" placeholder="*****************" type="password" required />
                                        </div>
                                        <!-- Port number -->
                                        <div class="form-group col-12 col-md-12 col-lg-6">
                                            <label for="mailPort" class="form-label">Mail Port Number<span class="text-danger">*</span>
                      </label>
                                            <input class="form-control" id="mailPort" placeholder="e.g. 465, 587" type="text" required />
                                        </div>
                                        <!-- Encryption -->
                                        <div class="form-group col-12 col-md-12 col-lg-6">
                                            <label for="mailEncryption" class="form-label">Mail Encryption (TLS / SSL)
                      </label>
...
<!-- Mirrored from codescandy.com/geeks/pages/dashboard/setting-smpt.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:33:18 GMT -->
</html>