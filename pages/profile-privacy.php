...
<!-- Mirrored from codescandy.com/geeks/pages/profile-privacy.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 18:14:27 GMT -->
<head>
	<!-- Required meta tags -->
<meta charset="utf-8">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
	<title>Profile Privacy | Geeks - Academy Admin Template</title>
</head>
									...
									<li class="list-group-item d-flex align-items-center justify-content-between px-0 py-2">
										...
										<div>
											<div class="custom-control custom-switch">
												<input type="checkbox" class="custom-control-input" id="swicthOne" checked />
												<label class="custom-control-label" for="swicthOne"></label>
											</div>
										</div>
									</li>
									<!-- List group item -->
